...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateEveryone() {
        ...
        // Draw animated elements representing image_generation
        ...
        ctxEveryone.fillText('Image Generation and Diffusion', centerX, 40);
    ...
    document.getElementById('btn-start').addEventListener('click', function() {
        if (!isRunning) {
            ...
            document.getElementById('explanation').innerHTML = 
                '<p>Watch how data flows through the image_generation process!</p>' +
    ...
    document.getElementById('btn-reset').addEventListener('click', function() {
        ...
        drawInitialState(ctxEveryone, canvasEveryone);
        document.getElementById('explanation').innerHTML = 
            '<p>Click "Start Demo" to see image_generation in action!</p>';
    });
    ...
    function drawTechnicalDemo(value) {
        ...
        ctxTech.fillText('Parameter Impact on image_generation', canvasTech.width/2, 30);
