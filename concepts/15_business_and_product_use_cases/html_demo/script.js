...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateEveryone() {
        ...
        // Draw animated elements representing business
        ...
        ctxEveryone.fillText('Business and Product Use Cases', centerX, 40);
    ...
    document.getElementById('btn-start').addEventListener('click', function() {
        if (!isRunning) {
            ...
            document.getElementById('explanation').innerHTML = 
                '<p>Watch how data flows through the business process!</p>' +
    ...
    document.getElementById('btn-reset').addEventListener('click', function() {
        ...
        drawInitialState(ctxEveryone, canvasEveryone);
        document.getElementById('explanation').innerHTML = 
            '<p>Click "Start Demo" to see business in action!</p>';
    });
    ...
    function drawTechnicalDemo(value) {
        ...
        ctxTech.fillText('Parameter Impact on business', canvasTech.width/2, 30);
