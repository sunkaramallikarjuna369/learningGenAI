...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateEveryone() {
        ...
        // Draw animated elements representing neural_networks
        ...
        ctxEveryone.fillText('Neural Network Basics', centerX, 40);
    ...
    document.getElementById('btn-start').addEventListener('click', function() {
        if (!isRunning) {
            ...
            document.getElementById('explanation').innerHTML = 
                '<p>Watch how data flows through the neural_networks process!</p>' +
    ...
    document.getElementById('btn-reset').addEventListener('click', function() {
        ...
        drawInitialState(ctxEveryone, canvasEveryone);
        document.getElementById('explanation').innerHTML = 
            '<p>Click "Start Demo" to see neural_networks in action!</p>';
    });
    ...
    function drawTechnicalDemo(value) {
        ...
        ctxTech.fillText('Parameter Impact on neural_networks', canvasTech.width/2, 30);
