...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateEveryone() {
        ...
        // Draw animated elements representing llms
        ...
        ctxEveryone.fillText('Large Language Models (LLMs)', centerX, 40);
    ...
    document.getElementById('btn-start').addEventListener('click', function() {
        if (!isRunning) {
            ...
            document.getElementById('explanation').innerHTML = 
                '<p>Watch how data flows through the llms process!</p>' +
    ...
    document.getElementById('btn-reset').addEventListener('click', function() {
        ...
        drawInitialState(ctxEveryone, canvasEveryone);
        document.getElementById('explanation').innerHTML = 
            '<p>Click "Start Demo" to see llms in action!</p>';
    });
    ...
    function drawTechnicalDemo(value) {
        ...
        ctxTech.fillText('Parameter Impact on llms', canvasTech.width/2, 30);
